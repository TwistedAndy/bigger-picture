...
function create_if_block(ctx) {
	let previous_tag = /*dialog*/ ctx[1] ? 'dialog' : 'div';
	let svelte_element_anchor;
	let current;
	let svelte_element = (/*dialog*/ ctx[1] ? 'dialog' : 'div') && create_dynamic_element(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			if (/*dialog*/ ctx[1] ? 'dialog' : 'div') {
				if (!previous_tag) {
					svelte_element = create_dynamic_element(ctx);
					previous_tag = /*dialog*/ ctx[1] ? 'dialog' : 'div';
					svelte_element.c();
					svelte_element.m(svelte_element_anchor.parentNode, svelte_element_anchor);
				} else if (not_equal(previous_tag, /*dialog*/ ctx[1] ? 'dialog' : 'div')) {
					svelte_element.d(1);
					svelte_element = create_dynamic_element(ctx);
					previous_tag = /*dialog*/ ctx[1] ? 'dialog' : 'div';
					svelte_element.c();
...
function create_if_block_4(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*activeItem*/ ctx[9].img) return 0;
		if (/*activeItem*/ ctx[9].sources) return 1;
		if (/*activeItem*/ ctx[9].iframe) return 2;
		return 3;
	}
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*activeItem*/ 512 && raw_value !== (raw_value = (/*activeItem*/ ctx[9].html ?? /*activeItem*/ ctx[9].element.outerHTML) + "")) div.innerHTML = raw_value;		},
		i: noop,
		o: noop,
		d(detaching) {
			if (detaching) {
...
function create_if_block_7(ctx) {
	...
	iframe = new Iframe({
			props: {
				props: /*getChildProps*/ ctx[19](),
				activeDimensions: /*activeDimensions*/ ctx[14]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*activeDimensions*/ 16384) iframe_changes.activeDimensions = /*activeDimensions*/ ctx[14];
...
function create_if_block_6(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const video_changes = {};
			if (dirty[0] & /*activeDimensions*/ 16384) video_changes.activeDimensions = /*activeDimensions*/ ctx[14];
...
function create_if_block_5(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*activeDimensions*/ 16384) imageitem_changes.activeDimensions = /*activeDimensions*/ ctx[14];
...
function create_key_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*containerWidth*/ ctx[8] > 0 && /*containerHeight*/ ctx[13] > 0 && create_if_block_4(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div, "pointerdown", /*pointerdown_handler*/ ctx[26]),
					listen(div, "pointerup", /*pointerup_handler*/ ctx[27])
				];
		...
		p(ctx, dirty) {
			if (/*containerWidth*/ ctx[8] > 0 && /*containerHeight*/ ctx[13] > 0) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty[0] & /*containerWidth, containerHeight*/ 8448) {
						transition_in(if_block, 1);
					}
				} else {
		...
		i(local) {
			...
			add_render_callback(() => {
				if (!current) return;
				if (div_outro) div_outro.end(1);
				div_intro = create_in_transition(div, /*mediaTransition*/ ctx[18], true);
				div_intro.start();
			});
		...
		o(local) {
			transition_out(if_block);
			if (div_intro) div_intro.invalidate();
			div_outro = create_out_transition(div, /*mediaTransition*/ ctx[18], false);
			current = false;
		},
		d(detaching) {
			if (detaching) {
...
function create_if_block_3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty[0] & /*activeItem*/ 512) && raw_value !== (raw_value = /*activeItem*/ ctx[9].caption + "")) div.innerHTML = raw_value;		},
		i(local) {
			if (current) return;
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*position, items*/ 65 && raw_value !== (raw_value = `${/*position*/ ctx[6] + 1} / ${/*items*/ ctx[0].length}` + "")) div.innerHTML = raw_value;		},
		d(detaching) {
			if (detaching) {
				detach(div);
				detach(button0);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*position*/ 64) thumbs_changes.position = /*position*/ ctx[6];
...
function create_dynamic_element(ctx) {
	...
	let div2;
	let div1;
	let previous_key = /*activeItem*/ ctx[9].i;
	let div0;
	let div3;
	let button;
	let div3_intro;
	...
	let mounted;
	let dispose;
	let if_block0 = !/*dialog*/ ctx[1] && create_if_block_8();
	let key_block = create_key_block(ctx);
	let if_block1 = /*activeItem*/ ctx[9].caption && create_if_block_3(ctx);
	let if_block2 = /*items*/ ctx[0].length > 1 && create_if_block_2(ctx);
	let if_block3 = /*opts*/ ctx[7].thumbs && /*items*/ ctx[0].length > 1 && create_if_block_1(ctx);

	return {
		c() {
			svelte_element = element(/*dialog*/ ctx[1] ? 'dialog' : 'div');
			if (if_block0) if_block0.c();
			div2 = element("div");
			div1 = element("div");
			key_block.c();
			...
			set_dynamic_element_data(/*dialog*/ ctx[1] ? 'dialog' : 'div')(svelte_element, { class: "bp-wrap" });
			toggle_class(svelte_element, "bp-zoomed", /*$zoomed*/ ctx[15]);
			toggle_class(svelte_element, "bp-inline", /*inline*/ ctx[11]);
			toggle_class(svelte_element, "bp-small", /*smallScreen*/ ctx[10]);
			toggle_class(svelte_element, "bp-noclose", /*opts*/ ctx[7].noClose);
			toggle_class(svelte_element, "bp-closing", /*$closing*/ ctx[16]);
		},
		m(target, anchor) {
			insert(target, svelte_element, anchor);
			if (if_block0) if_block0.m(svelte_element, null);
			append(svelte_element, div2);
			append(div2, div1);
			key_block.m(div1, null);
			append(div1, div0);
			if (if_block1) if_block1.m(div2, null);
			append(svelte_element, div3);
			append(div3, button);
			if (if_block2) if_block2.m(div3, null);
			if (if_block3) if_block3.m(svelte_element, null);
			current = true;

			if (!mounted) {
				dispose = [
					action_destroyer(/*rulerActions*/ ctx[21].call(null, div0)),
					listen(button, "click", /*close*/ ctx[2]),
					action_destroyer(/*containerActions*/ ctx[20].call(null, svelte_element))
				];
		...
		p(ctx, dirty) {
			if (!/*dialog*/ ctx[1]) {
				if (if_block0) {
					...
					if_block0.c();
					transition_in(if_block0, 1);
					if_block0.m(svelte_element, div2);
				}
			} else if (if_block0) {
				group_outros();
			...
			if (dirty[0] & /*activeItem*/ 512 && not_equal(previous_key, previous_key = /*activeItem*/ ctx[9].i)) {
				group_outros();
				...
				key_block.m(div1, div0);
			} else {
				key_block.p(ctx, dirty);
			}

			if (/*activeItem*/ ctx[9].caption) {
				if (if_block1) {
					if_block1.p(ctx, dirty);

					if (dirty[0] & /*activeItem*/ 512) {
						transition_in(if_block1, 1);
					}
				} else {
			...
			if (/*opts*/ ctx[7].thumbs && /*items*/ ctx[0].length > 1) {
				if (if_block3) {
					if_block3.p(ctx, dirty);

					if (dirty[0] & /*opts, items*/ 129) {
					...
					if_block3.c();
					transition_in(if_block3, 1);
					if_block3.m(svelte_element, null);
				}
			} else if (if_block3) {
				group_outros();
			...
			if (!current || dirty[0] & /*$zoomed*/ 32768) {
				toggle_class(svelte_element, "bp-zoomed", /*$zoomed*/ ctx[15]);
			}

			if (!current || dirty[0] & /*inline*/ 2048) {
				toggle_class(svelte_element, "bp-inline", /*inline*/ ctx[11]);
			}

			if (!current || dirty[0] & /*smallScreen*/ 1024) {
				toggle_class(svelte_element, "bp-small", /*smallScreen*/ ctx[10]);
			}

			if (!current || dirty[0] & /*opts*/ 128) {
				toggle_class(svelte_element, "bp-noclose", /*opts*/ ctx[7].noClose);
			}

			if (!current || dirty[0] & /*$closing*/ 65536) {
				toggle_class(svelte_element, "bp-closing", /*$closing*/ ctx[16]);
			}
		},
		i(local) {
...
function instance($$self, $$props, $$invalidate) {
	let $zoomed;
	let $closing;
	component_subscribe($$self, closing, $$value => $$invalidate(16, $closing = $$value));
 ...
 */
		...
		if (target) {
			$$invalidate(25, container = target);
		...
		$$invalidate(6, position = opts.position || 0);
 ...
 */
		...
		if (opts.items instanceof HTMLElement) {
			$$invalidate(7, opts.items = [opts.items], opts);
		} else {
			$$invalidate(7, opts.items = Array.from(opts.items), opts);
		}
	...
	const setPosition = index => {
		...
		$$invalidate(6, position = getNextPosition(index));
	};
 ...
 */
	const setDimensions = (item, thumb) => {
		if (thumb instanceof HTMLImageElement && (!item.width || !item.height)) {
			...
			item.scaled = 1;
			$$invalidate(14, activeDimensions = dimensions);
		}
	};
 ...
 */
	...
	const mediaTransition = (node, isEntering) => {
		if (!isOpen || !items) {
			...
			$$invalidate(24, isOpen = isEntering);
 ...
 */
		if (ruler) {
			$$invalidate(8, containerWidth = ruler.clientWidth);
	...
	const rulerActions = node => {
		...
		const rulerObserver = new ResizeObserver(entries => {
				...
				if (rect.width !== containerWidth || rect.height !== containerHeight) {
					$$invalidate(8, containerWidth = rect.width);
					$$invalidate(13, containerHeight = rect.height);
					$$invalidate(14, activeDimensions = calculateDimensions(activeItem));
				}
 ...
 */
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*items, position, activeItem, isOpen, opts, container*/ 50332353) {
			/**
 * Update the active item and dimensions on position change
 */
			if (items && items[position]) {
				$$invalidate(9, activeItem = items[position]);
				$$invalidate(14, activeDimensions = calculateDimensions(activeItem));
		...
		if ($$self.$$.dirty[0] & /*containerWidth*/ 256) {
